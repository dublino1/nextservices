...
UUID = "399414a7574a4a50a4ef2a031374b1ab"
import json
import time
import threading
import keyboard
...
class HotkeyPopup(ModalView):
    def __init__(self, triggerbot_instance, **kwargs):
        ...
        self.label = Label(text='Select new hotkey:', color=(0, 0, 255, 255), halign='center', valign='middle')
        ...
        self.submit_button = Button(text='Submit', background_color=(0, 0, 255, 255))
...
class SpotifyApp(App):
    def __init__(self, triggerbot_instance, **kwargs):
        super().__init__(**kwargs)
        self.triggerbot = triggerbot_instance
        self.title = "NextServices TriggerBot"
